          ...
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="text-center mb-5">
                <img src="{{ Vite::asset('resources/images/logo_iffar_c.png') }}" alt="Logo IFFar" class="img-fluid mb-4"
          ...
          <div class="row justify-content-center">
            <div class="col-md-10 col-lg-12">
              ...
              <div class="text-center mb-4 d-lg-none">
                <img src="{{ Vite::asset('resources/images/logo_iffar_c.png') }}" alt="Logo IFFar" class="img-fluid mb-3"
