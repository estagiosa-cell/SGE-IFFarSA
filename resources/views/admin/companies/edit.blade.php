                ...
                <form class="needs-validation" action="{{ route('admin.companies.update', $company->id) }}" method="POST"
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-md-4 mb-3">
                            <x-form.input name="legal_identifier" value="{{ $company->legal_identifier }}" label="CPF / CNPJ *" placeholder="CPF (11 dígitos) ou CNPJ (14 caracteres)" required feedback="O campo CPF/CNPJ é obrigatório." />
                        </div>
                    </div>
