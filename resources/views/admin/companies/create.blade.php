...
@section('main-content')
    <div class="container-fluid mt-4 mx-1">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form class="needs-validation" action="{{ route('admin.companies.store') }}" method="POST" novalidate>
                    @csrf
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('legal_identifier') is-invalid @enderror"
                                    id="legal_identifier" name="legal_identifier" value="{{ old('legal_identifier') }}"
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('address_street') is-invalid @enderror" id="address_street" name="address_street" value="{{ old('address_street') }}" placeholder="Ex: Rua Principal" required>
                         ...
                         <div class="col-md-4 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('address_number') is-invalid @enderror" id="address_number" name="address_number" value="{{ old('address_number') }}" placeholder="Ex: 123" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('address_neighborhood') is-invalid @enderror" id="address_neighborhood" name="address_neighborhood" value="{{ old('address_neighborhood') }}" placeholder="Ex: Centro" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('address_city') is-invalid @enderror" id="address_city" name="address_city" value="{{ old('address_city') }}" placeholder="Ex: Santo Augusto" required>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('address_zip') is-invalid @enderror" id="address_zip" name="address_zip" value="{{ old('address_zip') }}" placeholder="Ex: 98590-000" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('representative_name') is-invalid @enderror" id="representative_name" name="representative_name" value="{{ old('representative_name') }}" placeholder="Ex: João da Silva" required>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('representative_role') is-invalid @enderror" id="representative_role" name="representative_role" value="{{ old('representative_role') }}" placeholder="Ex: Sócio-Administrador" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Ex: (55) 99999-9999">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="Ex: contato@empresa.com">
                    ...
                    <h5 class="mb-3 pt-3 border-bottom pb-2">Informações Adicionais</h5>
                     <div class="row">
                        <div class="col-md-12 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('field_of_activity') is-invalid @enderror" id="field_of_activity" name="field_of_activity" value="{{ old('field_of_activity') }}" placeholder="Ex: Desenvolvimento de Software" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('professional_council') is-invalid @enderror" id="professional_council" name="professional_council" value="{{ old('professional_council') }}" placeholder="Ex: CREA-RS">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('council_registration_number') is-invalid @enderror" id="council_registration_number" name="council_registration_number" value="{{ old('council_registration_number') }}" placeholder="Ex: 123456">
                     ...
                     <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                <input type="text" class="form-control @error('process_number') is-invalid @enderror" id="process_number" name="process_number" value="{{ old('process_number') }}" placeholder="Ex: 23451.000123/2024-01">
